...
jQuery(function ($) {
    ...
    MineSweeper = function () {
        ...
        this.init = function (options) {
            ...
            msObj.initWorkers(msObj.options.path_to_cells);
            msObj.clearBoard();
            msObj.redrawBoard();
            msObj.resetDisplays();
        ...
        this.initHandlers = function (msUI) {
            ...
            $('#best_times').on("click", function (ev) {
                ...
                var advanced_time = localStorage.getItem('best_time_advanced') || 'None';
                ...
                var advanced_name = localStorage.getItem('advanced_record_holder') || 'None';
                alert("Best times:\nBeginner:\t" + beginner_name + "\t" + beginner_time + "\n" +
                    "Intermediate:\t" + intermediate_name + "\t" + intermediate_time + "\n" +
                    "Advanced:\t" + advanced_name + "\t" + advanced_time);
            });
        };
        ...
        this.handleLeftClick = function (cell) {
            ...
            if (msObj.worker) {
                ...
                if (!window.touchAdjacent) {
                    throw ("Could not load " + msObj.options.path_to_cells);
                }
